...
The v0.5.40 corrective preparation supersedes the quarantined prior tag without rewriting it and keeps v0.5.41 as the distinct unpublished candidate. The v0.5.40 tag, provider assets, Workflow Run, and final evidence bundle remain pending until the post-merge release workflow resolves the latest default-branch commit and verifies them.
