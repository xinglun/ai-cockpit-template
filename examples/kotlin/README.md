...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.3 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.3/install.sh)" -- --stack kotlin --update-makefile --create-adoption
```
