...
AI Cockpit governs evidence; it does not replace evidence-producing tools. Native Governance Evidence / Delegated Domain Evidence の分類と Release の責任境界は [設計思想](docs/philosophy/design-philosophy.md) で定義します。
