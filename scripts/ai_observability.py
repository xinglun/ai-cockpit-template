...
class AiObservability:
    ...
    def check_started(self, *, check_id: str, command: str | None = None) -> None:
        self.record(AiEvent(AiEventType.CHECK_STARTED, AiEventLevel.INFO, f"check started: {check_id}", check_id=check_id, command=command))
    ...
    def check_passed(
        ...
        *,
        ...
        self.record(AiEvent(AiEventType.CHECK_PASSED, AiEventLevel.INFO, f"check passed: {check_id}", check_id=check_id, command=command, result="passed", duration_ms=duration_ms, fields=fields or {}))
    ...
    def check_failed(
        ...
        *,
        ...
        self.record(AiEvent(AiEventType.CHECK_FAILED, AiEventLevel.ERROR, f"check failed: {check_id}", check_id=check_id, command=command, result="failed", duration_ms=duration_ms, detail=detail))
    ...
    def work_item_started(self, *, fields: dict[str, Any] | None = None) -> None:
        ...
        self.record(AiEvent(AiEventType.WORK_ITEM_STARTED, AiEventLevel.INFO, f"work item started: {work_item_id}", fields=fields or {}))
    ...
    def work_item_finished(self, *, result: str, duration_ms: int | None = None) -> None:
        ...
        self.record(AiEvent(AiEventType.WORK_ITEM_FINISHED, level, f"work item finished: {work_item_id}", result=result, duration_ms=duration_ms))

    def status_generated(self, *, state: str, output_path: str, fields: dict[str, Any] | None = None) -> None:
        self.record(AiEvent(AiEventType.STATUS_GENERATED, AiEventLevel.INFO, f"cockpit status generated: {state}", result=state, path=output_path, fields=fields or {}))
