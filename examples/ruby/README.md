...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.5 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.5/install.sh)" -- --stack ruby --update-makefile --create-adoption
```
