...
- Antigravity とその他のエージェント: 同じ Contract、Summary、Makefile、guard workflow を使います。
...
- 既存の `AGENTS.md`、`GEMINI.md`、`CLAUDE.md` には AI Cockpit section を追記します。
- Cursor rules を `.cursor/rules/ai-cockpit.mdc` にインストールします。
