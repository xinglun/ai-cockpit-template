...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.9 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.9/install.sh)" -- --stack python --update-makefile --create-adoption
```
