...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.16 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.16/install.sh)" -- --stack typescript --update-makefile --create-adoption
```
