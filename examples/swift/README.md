...
```sh
AI_COCKPIT_TEMPLATE_REF=v0.5.11 sh -c "$(curl -fsSL https://raw.githubusercontent.com/xinglun/ai-cockpit-template/v0.5.11/install.sh)" -- --stack swift --update-makefile --create-adoption
```
