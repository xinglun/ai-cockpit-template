...
- Preserve the previous immutable public release and the current PR-first exact-SHA workflow.
...
- `release.json`: update only if regenerated evidence requires the current release claims to change; preserve the previous immutable public release.
